...
Shader "TV_Screen_Effect"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 break19_g10 = float2( -0.5,0.5 );
			float temp_output_1_0_g10 = ( _Time.y * 20.0 );
			...
			float4 temp_cast_1 = (( ( dotResult21 + ( ( simplePerlin2D25 - 0.5 ) * 0.15 ) ) * ( 1.0 - ( ( lerpResult20_g10 + sinIn7_g10 ) * 0.05 ) ) )).xxxx;
			...
			float2 break19_g11 = float2( -0.5,0.5 );
			...
			float temp_output_98_0 = ( ( ( temp_output_93_0 * temp_output_93_0 ) + ( temp_output_94_0 * temp_output_94_0 ) ) * 0.15 );
			...
			float temp_output_1_0_g11 = ( (temp_output_102_0).y * 120.0 );
			float sinIn7_g11 = sin( temp_output_1_0_g11 );
			float sinInOffset6_g11 = sin( ( temp_output_1_0_g11 + 1.0 ) );
			float lerpResult20_g11 = lerp( break19_g11.x , break19_g11.y , frac( ( sin( ( ( sinIn7_g11 - sinInOffset6_g11 ) * 91.2228 ) ) * 43758.55 ) ));
			float lerpResult121 = lerp( 1.0 , ( ( ( lerpResult20_g11 + sinIn7_g11 ) * 0.5 ) + 0.5 ) , 0.25);
...
/*ASEBEGIN
Version=18900
0;73;1920;920;4144.775;-1334.56;3.385086;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-2213.167,2181.191;Inherit;False;Constant;_CurveAmount;_CurveAmount  ;2;0;Create;True;0;0;0;False;0;False;0.15;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;86;-2569.47,2573.49;Inherit;False;Constant;_ScanlineCount;_ScanlineCount  ;2;0;Create;True;0;0;0;False;0;False;120;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;117;-2281.051,2512.47;Inherit;False;Noise Sine Wave;-1;;11;a6eff29f739ced848846e3b648af87bd;0;2;1;FLOAT;0;False;2;FLOAT2;-0.5,0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;32;227.4125,3705.211;Inherit;False;Noise Sine Wave;-1;;10;a6eff29f739ced848846e3b648af87bd;0;2;1;FLOAT;0;False;2;FLOAT2;-0.5,0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;187.2988,3514.526;Inherit;False;Constant;_NoiseAmount;_NoiseAmount;2;0;Create;True;0;0;0;False;0;False;0.15;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;181.4247,3795.078;Inherit;False;Constant;_Flicker;Flicker;2;0;Create;True;0;0;0;False;0;False;0.05;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-2036.975,2630.552;Inherit;False;Constant;_ScanlineStrength;_ScanlineStrength ;2;0;Create;True;0;0;0;False;0;False;0.25;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;126;-1943.066,2949.234;Inherit;False;Noise Sine Wave;-1;;12;a6eff29f739ced848846e3b648af87bd;0;2;1;FLOAT;0;False;2;FLOAT2;-0.5,0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;88;-1573.733,2503.335;Inherit;False;Constant;_ChromaAmount;_ChromaAmount;2;0;Create;True;0;0;0;False;0;False;0.006;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=8CE41E8D2F742F9EC9B3ADD0DCCCDAABEBCA8013