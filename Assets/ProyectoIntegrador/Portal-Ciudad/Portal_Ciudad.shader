...
Shader "Portal_Ciudad"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_32_0 = distance( ( uv_RTTexture * _EscalaCirculo ) , _DistanceCirculo );
			float DistanceCirculo52 = temp_output_32_0;
			float temp_output_37_0 = ( 1.0 - step( DistanceCirculo52 , _RadioCirculo ) );
			float CirculoCiudad39 = temp_output_37_0;
...
/*ASEBEGIN
Version=18900
0;843;1989;508;1100.646;399.7831;1.3;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;56;732.183,308.9023;Inherit;False;55;BordeCirculo;1;0;OBJECT;;False;1;COLOR;0
...
ASEEND*/
//CHKSM=2C3CEAD78A71F577D55185E889900A21BC0E722C