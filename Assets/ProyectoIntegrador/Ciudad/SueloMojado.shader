...
Shader "SueloMojado"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode39 = tex2D( _WetMask, uv_TexCoord78 );
			float4 temp_cast_0 = (_WetContrast).xxxx;
			float4 WetMask53 = pow( ( tex2DNode39 * _WetAmount ) , temp_cast_0 );
			...
			float4 temp_cast_2 = (( AlbedoNormal65 * _WetDarkness )).xxxx;
			float4 lerpResult46 = lerp( AlbedoNormal65 , temp_cast_2 , WetMask53);
			o.Albedo = lerpResult46.rgb;
			float2 uv_Roughness = i.uv_texcoord * _Roughness_ST.xy + _Roughness_ST.zw;
			float4 Roughness59 = ( 1.0 - tex2D( _Roughness, uv_Roughness ) );
			float4 temp_cast_4 = (_WetSmoothness).xxxx;
			float4 lerpResult47 = lerp( Roughness59 , temp_cast_4 , WetMask53);
...
/*ASEBEGIN
Version=18900
0;843;1989;508;-1003.675;102.5833;1;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;87;-1160.846,1436.775;Inherit;True;Property;_WaterNormal;WaterNormal;11;0;Create;True;0;0;0;False;0;False;b59a96d28fb580141956844b613d65b2;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=99CD3560AECBC24B9B00A68BF24861D87DF70D6A